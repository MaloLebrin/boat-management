...
import { ADDON_PRICES, MODULE_PRICES, PLAN_LIMITS, PLAN_PRICES } from '#shared/types/plan'
import type {
  HelpPageProps,
  LegalEntry,
  MarketingI18n,
...
/**
 * Copie des pages marketing statiques (vague 2.1) : une méthode par page,
 * qui rend exactement les props attendues par `inertia/pages/marketing/*`.
 * Le contrat est figé par `tests/functional/marketing/__fixtures__`.
 */
@inject()
export default class MarketingContentService {
      ...
      home: {
        ...
        faq: {
          ...
          items: [
            ...
            {
              q: i18n.t('marketing.home.faq.item4_q', this.pricingTable.copyParams(locale)),
              a: i18n.t('marketing.home.faq.item4_a', this.pricingTable.copyParams(locale)),
            },
  ...
  pricingPage(i18n: MarketingI18n) {
    const priceParams = this.pricingTable.copyParams(i18n.locale)
          ...
          groups: [
            {
              ...
              rows: [
                [
                  ...
                  this.pricingTable.quotaCell(
                    t,
                    PLAN_LIMITS.pro.maxBoats,
                    'table_g1_r1_p',
                    'table_g1_r1_e'
                  ),
                  this.pricingTable.quotaCell(
                    t,
                    PLAN_LIMITS.enterprise.maxBoats,
                    'table_g1_r1_p',
                    'table_g1_r1_e'
                  ),
                ],
                [
                  ...
                  this.pricingTable.quotaCell(
                    t,
                    PLAN_LIMITS.pro.maxMembers,
                    'table_g1_r2_p',
                    'table_g1_r2_e'
                  ),
                  this.pricingTable.quotaCell(
                    t,
                    PLAN_LIMITS.enterprise.maxMembers,
                    'table_g1_r2_p',
                    'table_g1_r2_e'
                  ),
                ],
                [t('table_g1_r4'), true, true, true],
                this.pricingTable.flagRow(t, 'table_g1_r6', 'canWhiteLabel'),
              ] as PricingTableRow[],
            },
            {
              title: t('table_g2'),
            ...
            },
            {
              ...
              rows: [
                ...
                [
                  t('table_g3_r3'),
                  this.pricingTable.auditCell(t, PLAN_LIMITS.starter.auditLogRetentionDays),
                  this.pricingTable.auditCell(t, PLAN_LIMITS.pro.auditLogRetentionDays),
                  this.pricingTable.auditCell(t, PLAN_LIMITS.enterprise.auditLogRetentionDays),
                ],
            ...
            },
            {
              title: t('table_g4'),
              rows: [
                this.pricingTable.flagRow(t, 'table_g4_r1', 'canUseAI'),
                this.pricingTable.flagRow(t, 'table_g4_r2', 'canUseAI'),
                this.pricingTable.flagRow(t, 'table_g4_r3', 'canUseAI'),
                this.pricingTable.flagRow(t, 'table_g4_r4', 'canUseAI'),
                this.pricingTable.flagRow(t, 'table_g4_r5', 'canCustomizeAI'),
            ...
            },
            {
              ...
              rows: [
                [
                  ...
                  this.pricingTable.quotaCell(
                    t,
                    PLAN_LIMITS.starter.storageGb,
                    'table_g5_r1_gb',
                    'table_g5_r1_e'
                  ),
                  this.pricingTable.quotaCell(
                    t,
                    PLAN_LIMITS.pro.storageGb,
                    'table_g5_r1_gb',
                    'table_g5_r1_e'
                  ),
                  this.pricingTable.quotaCell(
                    t,
                    PLAN_LIMITS.enterprise.storageGb,
                    'table_g5_r1_gb',
                    'table_g5_r1_e'
                  ),
                ],
  ...
  aboutPage(i18n: Pick<MarketingI18n, 't'>) {
  ...
  guidePage(i18n: Pick<MarketingI18n, 't'>) {
    const t = (key: string, params?: Record<string, string>) =>
  ...
  privacyPage(i18n: Pick<MarketingI18n, 't'>) {
   ...
   */
  termsPage(i18n: Pick<MarketingI18n, 't'>) {
   ...
   */
  legalNoticePage(i18n: Pick<MarketingI18n, 't'>) {
   ...
   */
  salesTermsPage(i18n: Pick<MarketingI18n, 't'>) {
  ...
  contactPage(i18n: Pick<MarketingI18n, 't'>) {
