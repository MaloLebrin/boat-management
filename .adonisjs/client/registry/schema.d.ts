...
export interface Registry {
  ...
  'boats.pricing.update': {
    ...
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/boat_pricing').upsertBoatPricingValidator)>>
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
  ...
  'boats.engines.photos.destroy': {
    ...
    types: {
      ...
      params: { boatId: ParamValue; engineId: ParamValue; mediaId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
    }
  }
  ...
  'boats.sails.show': {
    ...
    types: {
      ...
      params: { boatId: ParamValue; sailId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_equipment_controller').default['showSail']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_equipment_controller').default['showSail']>>>
    }
  }
  ...
  'boats.sails.photos.destroy': {
    ...
    types: {
      body: {}
      paramsTuple: [ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; sailId: ParamValue; mediaId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
    }
  ...
  'boats.rig.show': {
    ...
    types: {
      ...
      params: { boatId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_equipment_controller').default['showRig']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_equipment_controller').default['showRig']>>>
    }
  }
  ...
  'boats.safetyEquipment.show': {
    ...
    types: {
      ...
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_safety_equipment_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_safety_equipment_controller').default['show']>>>
    }
  }
  ...
  'boats.safetyEquipment.photos.destroy': {
    ...
    types: {
      body: {}
      paramsTuple: [ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; safetyId: ParamValue; mediaId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
    }
  ...
  'boats.genericEquipment.show': {
    ...
    types: {
      ...
      params: { boatId: ParamValue; itemId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_generic_equipment_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_generic_equipment_controller').default['show']>>>
    }
  }
  ...
  'boats.genericEquipment.photos.destroy': {
    ...
    types: {
      body: {}
      paramsTuple: [ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; genericId: ParamValue; mediaId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_equipment_media_controller').default['destroy']>>>
    }
  ...
  'boats.reservations.inspection.show': {
    ...
    types: {
      ...
      params: { boatId: ParamValue; reservationId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['show']>>>
    }
  }
  'boats.reservations.inspections.store': {
    ...
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/boat_inspection').createBoatInspectionValidator)>>
      paramsTuple: [ParamValue, ParamValue]
      params: { boatId: ParamValue; reservationId: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/boat_inspection').createBoatInspectionValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['store']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'boats.reservations.inspections.update': {
    ...
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/boat_inspection').updateBoatInspectionValidator)>>
      paramsTuple: [ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; reservationId: ParamValue; inspectionId: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/boat_inspection').updateBoatInspectionValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['update']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'boats.reservations.inspections.destroy': {
    ...
    types: {
      ...
      params: { boatId: ParamValue; reservationId: ParamValue; inspectionId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['destroy']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['destroy']>>>
    }
  }
  'boats.reservations.inspections.items.set': {
    methods: ["PATCH"]
    pattern: '/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/boat_inspection').setBoatInspectionItemValidator)>>
      paramsTuple: [ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; reservationId: ParamValue; inspectionId: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/boat_inspection').setBoatInspectionItemValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['setItem']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['setItem']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'boats.reservations.inspections.items.destroy': {
    methods: ["DELETE"]
    pattern: '/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/boat_inspection').clearBoatInspectionItemValidator)>>
      paramsTuple: [ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; reservationId: ParamValue; inspectionId: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/boat_inspection').clearBoatInspectionItemValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['destroyItem']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/boat_inspections_controller').default['destroyItem']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  ...
  'boats.reservations.inspections.photos.destroy': {
    ...
    types: {
      body: {}
      paramsTuple: [ParamValue, ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; reservationId: ParamValue; inspectionId: ParamValue; mediaId: ParamValue }
      query: {}
  ...
  'invitations.decline': {
    ...
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/organization_member').declineInvitationValidator)>>
      paramsTuple: []
      params: {}
      query: ExtractQuery<InferInput<(typeof import('#validators/organization_member').declineInvitationValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/organization_invitations_controller').default['decline']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/organization_invitations_controller').default['decline']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'webhooks.stripe': {
    methods: ["POST"]
  ...
  'pricingSeasons.index': {
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/pricing_seasons_controller').default['index']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/pricing_seasons_controller').default['index']>>>
    }
  }
  'pricingSeasons.store': {
    ...
    pattern: '/pricing/seasons'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/pricing_season').createPricingSeasonValidator)>>
      paramsTuple: []
      params: {}
      query: ExtractQuery<InferInput<(typeof import('#validators/pricing_season').createPricingSeasonValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/pricing_seasons_controller').default['store']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/pricing_seasons_controller').default['store']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'pricingSeasons.update': {
    ...
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/pricing_season').updatePricingSeasonValidator)>>
      paramsTuple: [ParamValue]
      params: { id: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/pricing_season').updatePricingSeasonValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/pricing_seasons_controller').default['update']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/pricing_seasons_controller').default['update']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  ...
  'marketing.en.maintenance': {
    methods: ["GET","HEAD"]
    pattern: '/en/boat-maintenance-log'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/marketing_features_controller').default['maintenance']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/marketing_features_controller').default['maintenance']>>>
    }
  }
  'marketing.en.fleet': {
    methods: ["GET","HEAD"]
    pattern: '/en/boat-fleet-management'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/marketing_features_controller').default['fleet']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/marketing_features_controller').default['fleet']>>>
    }
  }
  'marketing.en.aiAssistant': {
    methods: ["GET","HEAD"]
    pattern: '/en/ai-boat-assistant'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/marketing_features_controller').default['aiAssistant']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/marketing_features_controller').default['aiAssistant']>>>
    }
  }
  ...
  'marketing.en.partsAi': {
    methods: ["GET","HEAD"]
    pattern: '/en/engine-part-finder-ai'
    types: {
      body: {}
      paramsTuple: []
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/public_part_search_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/public_part_search_controller').default['show']>>>
    }
  }
  'marketing.en.help': {
    methods: ["GET","HEAD"]
    ...
    types: {
      ...
      params: {}
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/marketing_controller').default['help']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/marketing_controller').default['help']>>>
    }
  }
  ...
  'marketing.fr.maintenance': {
    methods: ["GET","HEAD"]
    pattern: '/fr/carnet-entretien-bateau'
    types: {
      body: {}
      paramsTuple: []
      params: {}
  ...
  'marketing.fr.fleet': {
    methods: ["GET","HEAD"]
    pattern: '/fr/gestion-flotte-bateaux'
    types: {
      body: {}
      paramsTuple: []
      params: {}
  ...
  'marketing.fr.aiAssistant': {
    methods: ["GET","HEAD"]
    pattern: '/fr/assistant-ia-bateau'
    types: {
      body: {}
      paramsTuple: []
      params: {}
  ...
  'marketing.fr.partsAi': {
    methods: ["GET","HEAD"]
    pattern: '/fr/reference-piece-moteur-ia'
    types: {
      body: {}
      paramsTuple: []
      params: {}
  ...
  'public_part_search.start': {
    methods: ["POST"]
    pattern: '/parts-ai/conversations'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/spare_part_chat').publicPartSearchStartValidator)>>
      paramsTuple: []
      params: {}
      query: ExtractQuery<InferInput<(typeof import('#validators/spare_part_chat').publicPartSearchStartValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/public_part_search_controller').default['start']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/public_part_search_controller').default['start']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'public_part_search.message': {
    methods: ["POST"]
    pattern: '/parts-ai/conversations/:token/messages'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/spare_part_chat').publicPartSearchMessageValidator)>>
      paramsTuple: [ParamValue]
      params: { token: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/spare_part_chat').publicPartSearchMessageValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/public_part_search_controller').default['message']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/public_part_search_controller').default['message']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  ...
  'spareParts.chat.show': {
    methods: ["GET","HEAD"]
    pattern: '/boats/:boatId/engines/:engineId/spare-parts/chat'
    types: {
      body: {}
      paramsTuple: [ParamValue, ParamValue]
      params: { boatId: ParamValue; engineId: ParamValue }
      query: {}
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/spare_part_chat_controller').default['show']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/spare_part_chat_controller').default['show']>>>
    }
  }
  'spareParts.chat.start': {
    methods: ["POST"]
    pattern: '/boats/:boatId/engines/:engineId/spare-parts/chat/conversations'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/spare_part_chat').sparePartChatMessageValidator)>>
      paramsTuple: [ParamValue, ParamValue]
      params: { boatId: ParamValue; engineId: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/spare_part_chat').sparePartChatMessageValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/spare_part_chat_controller').default['start']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/spare_part_chat_controller').default['start']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'spareParts.chat.message': {
    methods: ["POST"]
    pattern: '/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages'
    types: {
      body: ExtractBody<InferInput<(typeof import('#validators/spare_part_chat').sparePartChatMessageValidator)>>
      paramsTuple: [ParamValue, ParamValue, ParamValue]
      params: { boatId: ParamValue; engineId: ParamValue; token: ParamValue }
      query: ExtractQuery<InferInput<(typeof import('#validators/spare_part_chat').sparePartChatMessageValidator)>>
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/spare_part_chat_controller').default['message']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/spare_part_chat_controller').default['message']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'spareParts.cart.add': {
    methods: ["POST"]
