...
const routes = {
  ...
  'boats.reservations.inspections.items.set': {
    ...
    tokens: [{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"reservations","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":1,"val":"reservationId","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"inspections","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":1,"val":"inspectionId","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"items","end":""}],
    types: placeholder as Registry['boats.reservations.inspections.items.set']['types'],
  },
  'boats.reservations.inspections.items.destroy': {
    methods: ["DELETE"],
    pattern: '/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items',
    tokens: [{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"reservations","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":1,"val":"reservationId","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"inspections","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":1,"val":"inspectionId","end":""},{"old":"/boats/:boatId/reservations/:reservationId/inspections/:inspectionId/items","type":0,"val":"items","end":""}],
    types: placeholder as Registry['boats.reservations.inspections.items.destroy']['types'],
  },
  ...
  'diagnostic.index': {
    methods: ["GET","HEAD"],
    pattern: '/diagnostic',
    tokens: [{"old":"/diagnostic","type":0,"val":"diagnostic","end":""}],
    types: placeholder as Registry['diagnostic.index']['types'],
  },
  'diagnostic.firstContact': {
    methods: ["GET","HEAD"],
    pattern: '/diagnostic/first-contact',
    tokens: [{"old":"/diagnostic/first-contact","type":0,"val":"diagnostic","end":""},{"old":"/diagnostic/first-contact","type":0,"val":"first-contact","end":""}],
    types: placeholder as Registry['diagnostic.firstContact']['types'],
  },
  'diagnostic.checklist': {
    methods: ["GET","HEAD"],
    pattern: '/boats/:boatId/engines/:engineId/diagnostic',
    tokens: [{"old":"/boats/:boatId/engines/:engineId/diagnostic","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic","type":0,"val":"engines","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic","type":1,"val":"engineId","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic","type":0,"val":"diagnostic","end":""}],
    types: placeholder as Registry['diagnostic.checklist']['types'],
  },
  'diagnostic.sheet': {
    methods: ["GET","HEAD"],
    pattern: '/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug',
    tokens: [{"old":"/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug","type":0,"val":"engines","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug","type":1,"val":"engineId","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug","type":0,"val":"diagnostic","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug","type":0,"val":"sheets","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/sheets/:sheetSlug","type":1,"val":"sheetSlug","end":""}],
    types: placeholder as Registry['diagnostic.sheet']['types'],
  },
  'diagnostic.steps.toggle': {
    methods: ["PATCH"],
    pattern: '/boats/:boatId/engines/:engineId/diagnostic/steps',
    tokens: [{"old":"/boats/:boatId/engines/:engineId/diagnostic/steps","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/steps","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/steps","type":0,"val":"engines","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/steps","type":1,"val":"engineId","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/steps","type":0,"val":"diagnostic","end":""},{"old":"/boats/:boatId/engines/:engineId/diagnostic/steps","type":0,"val":"steps","end":""}],
    types: placeholder as Registry['diagnostic.steps.toggle']['types'],
  },
  'diagnostic.reset': {
    methods: ["DELETE"],
  ...
  'marketing.en.maintenance': {
    ...
    tokens: [{"old":"/en/boat-maintenance-log","type":0,"val":"en","end":""},{"old":"/en/boat-maintenance-log","type":0,"val":"boat-maintenance-log","end":""}],
    types: placeholder as Registry['marketing.en.maintenance']['types'],
  },
  'marketing.en.fleet': {
    methods: ["GET","HEAD"],
    pattern: '/en/boat-fleet-management',
    tokens: [{"old":"/en/boat-fleet-management","type":0,"val":"en","end":""},{"old":"/en/boat-fleet-management","type":0,"val":"boat-fleet-management","end":""}],
    types: placeholder as Registry['marketing.en.fleet']['types'],
  },
  'marketing.en.aiAssistant': {
    methods: ["GET","HEAD"],
    pattern: '/en/ai-boat-assistant',
    tokens: [{"old":"/en/ai-boat-assistant","type":0,"val":"en","end":""},{"old":"/en/ai-boat-assistant","type":0,"val":"ai-boat-assistant","end":""}],
    types: placeholder as Registry['marketing.en.aiAssistant']['types'],
  },
  ...
  'marketing.en.partsAi': {
    ...
    tokens: [{"old":"/en/engine-part-finder-ai","type":0,"val":"en","end":""},{"old":"/en/engine-part-finder-ai","type":0,"val":"engine-part-finder-ai","end":""}],
    types: placeholder as Registry['marketing.en.partsAi']['types'],
  },
  'marketing.en.help': {
    methods: ["GET","HEAD"],
    pattern: '/en/help',
    tokens: [{"old":"/en/help","type":0,"val":"en","end":""},{"old":"/en/help","type":0,"val":"help","end":""}],
    types: placeholder as Registry['marketing.en.help']['types'],
  },
  ...
  'marketing.en.terms': {
    methods: ["GET","HEAD"],
    pattern: '/en/terms',
    tokens: [{"old":"/en/terms","type":0,"val":"en","end":""},{"old":"/en/terms","type":0,"val":"terms","end":""}],
    types: placeholder as Registry['marketing.en.terms']['types'],
  },
  'marketing.en.sales_terms': {
    methods: ["GET","HEAD"],
    pattern: '/en/sales-terms',
    tokens: [{"old":"/en/sales-terms","type":0,"val":"en","end":""},{"old":"/en/sales-terms","type":0,"val":"sales-terms","end":""}],
    types: placeholder as Registry['marketing.en.sales_terms']['types'],
  },
  'marketing.en.legal_notice': {
    methods: ["GET","HEAD"],
    pattern: '/en/legal-notice',
    tokens: [{"old":"/en/legal-notice","type":0,"val":"en","end":""},{"old":"/en/legal-notice","type":0,"val":"legal-notice","end":""}],
    types: placeholder as Registry['marketing.en.legal_notice']['types'],
  },
  'marketing.fr.home': {
    methods: ["GET","HEAD"],
    pattern: '/fr',
  ...
  'marketing.fr.maintenance': {
    ...
    tokens: [{"old":"/fr/carnet-entretien-bateau","type":0,"val":"fr","end":""},{"old":"/fr/carnet-entretien-bateau","type":0,"val":"carnet-entretien-bateau","end":""}],
    types: placeholder as Registry['marketing.fr.maintenance']['types'],
  },
  'marketing.fr.fleet': {
    methods: ["GET","HEAD"],
    pattern: '/fr/gestion-flotte-bateaux',
    tokens: [{"old":"/fr/gestion-flotte-bateaux","type":0,"val":"fr","end":""},{"old":"/fr/gestion-flotte-bateaux","type":0,"val":"gestion-flotte-bateaux","end":""}],
    types: placeholder as Registry['marketing.fr.fleet']['types'],
  },
  'marketing.fr.aiAssistant': {
    methods: ["GET","HEAD"],
    pattern: '/fr/assistant-ia-bateau',
    tokens: [{"old":"/fr/assistant-ia-bateau","type":0,"val":"fr","end":""},{"old":"/fr/assistant-ia-bateau","type":0,"val":"assistant-ia-bateau","end":""}],
    types: placeholder as Registry['marketing.fr.aiAssistant']['types'],
  },
  ...
  'marketing.fr.partsAi': {
    ...
    tokens: [{"old":"/fr/reference-piece-moteur-ia","type":0,"val":"fr","end":""},{"old":"/fr/reference-piece-moteur-ia","type":0,"val":"reference-piece-moteur-ia","end":""}],
    types: placeholder as Registry['marketing.fr.partsAi']['types'],
  },
  'marketing.fr.help': {
    methods: ["GET","HEAD"],
    pattern: '/fr/aide',
    tokens: [{"old":"/fr/aide","type":0,"val":"fr","end":""},{"old":"/fr/aide","type":0,"val":"aide","end":""}],
    types: placeholder as Registry['marketing.fr.help']['types'],
  },
  ...
  'marketing.fr.terms': {
    methods: ["GET","HEAD"],
    pattern: '/fr/cgu',
    tokens: [{"old":"/fr/cgu","type":0,"val":"fr","end":""},{"old":"/fr/cgu","type":0,"val":"cgu","end":""}],
    types: placeholder as Registry['marketing.fr.terms']['types'],
  },
  'marketing.fr.sales_terms': {
    methods: ["GET","HEAD"],
    pattern: '/fr/cgv',
    tokens: [{"old":"/fr/cgv","type":0,"val":"fr","end":""},{"old":"/fr/cgv","type":0,"val":"cgv","end":""}],
    types: placeholder as Registry['marketing.fr.sales_terms']['types'],
  },
  'marketing.fr.legal_notice': {
    methods: ["GET","HEAD"],
    pattern: '/fr/mentions-legales',
    tokens: [{"old":"/fr/mentions-legales","type":0,"val":"fr","end":""},{"old":"/fr/mentions-legales","type":0,"val":"mentions-legales","end":""}],
    types: placeholder as Registry['marketing.fr.legal_notice']['types'],
  },
  'marketing.en.about': {
    methods: ["GET","HEAD"],
    pattern: '/en/about',
  ...
  'public_part_search.start': {
    ...
    tokens: [{"old":"/parts-ai/conversations","type":0,"val":"parts-ai","end":""},{"old":"/parts-ai/conversations","type":0,"val":"conversations","end":""}],
    types: placeholder as Registry['public_part_search.start']['types'],
  },
  'public_part_search.message': {
    methods: ["POST"],
    pattern: '/parts-ai/conversations/:token/messages',
    tokens: [{"old":"/parts-ai/conversations/:token/messages","type":0,"val":"parts-ai","end":""},{"old":"/parts-ai/conversations/:token/messages","type":0,"val":"conversations","end":""},{"old":"/parts-ai/conversations/:token/messages","type":1,"val":"token","end":""},{"old":"/parts-ai/conversations/:token/messages","type":0,"val":"messages","end":""}],
    types: placeholder as Registry['public_part_search.message']['types'],
  },
  ...
  'spareParts.chat.show': {
    ...
    tokens: [{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat","type":0,"val":"engines","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat","type":1,"val":"engineId","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat","type":0,"val":"spare-parts","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat","type":0,"val":"chat","end":""}],
    types: placeholder as Registry['spareParts.chat.show']['types'],
  },
  'spareParts.chat.start': {
    methods: ["POST"],
    pattern: '/boats/:boatId/engines/:engineId/spare-parts/chat/conversations',
    tokens: [{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations","type":0,"val":"engines","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations","type":1,"val":"engineId","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations","type":0,"val":"spare-parts","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations","type":0,"val":"chat","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations","type":0,"val":"conversations","end":""}],
    types: placeholder as Registry['spareParts.chat.start']['types'],
  },
  'spareParts.chat.message': {
    methods: ["POST"],
    pattern: '/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages',
    tokens: [{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":0,"val":"boats","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":1,"val":"boatId","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":0,"val":"engines","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":1,"val":"engineId","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":0,"val":"spare-parts","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":0,"val":"chat","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":0,"val":"conversations","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":1,"val":"token","end":""},{"old":"/boats/:boatId/engines/:engineId/spare-parts/chat/conversations/:token/messages","type":0,"val":"messages","end":""}],
    types: placeholder as Registry['spareParts.chat.message']['types'],
  },
  'spareParts.cart.add': {
    methods: ["POST"],
