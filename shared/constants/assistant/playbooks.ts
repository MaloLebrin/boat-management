...
export const ASSISTANT_PLAYBOOKS: AssistantPlaybook[] = [
  ...
  },
  {
    ...
    body: {
      fr: "Les capacités dépendent du plan de l'organisation et de ses modules : réservations/clients/factures relèvent d'Entreprise ou du module Location saisonnière, les ports des plans Pro et Entreprise. Pour toute question de plan, quotas (bateaux, membres, tokens IA du mois) ou abonnement, appelez get_organization_status plutôt que de supposer — et search_product_help pour le « comment faire ». L'IA se règle dans Réglages — IA : instructions personnalisées de l'organisation et clé API propre (BYOK Mistral, Claude, ChatGPT ou Gemini) qui lève le quota de tokens de l'app. Si une fonctionnalité manque, dites quel plan ou module la débloque et proposez navTarget settings.billing.",
      en: 'Capabilities depend on the organization plan and modules: reservations/clients/invoices belong to Enterprise or the seasonal charter module, ports to Pro and Enterprise plans. For any question about plan, quotas (boats, members, monthly AI tokens) or subscription, call get_organization_status rather than assuming — and search_product_help for the “how do I”. AI is configured in Settings — AI: organization custom instructions and its own API key (BYOK Mistral, Claude, ChatGPT or Gemini) which lifts the app token quota. When a feature is missing, say which plan or module unlocks it and suggest navTarget settings.billing.',
    },
    keywords: [
      'plan',
      'abonnement',
