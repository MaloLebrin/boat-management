...
router.on('/design-system').renderInertia('design_system', {
  meta: {
    title: 'Design System – FleetAi',
    description: 'Foundations, components and patterns of the FleetAi design system. Built on Tailwind CSS v4, Vue 3 and Instrument Serif.',
  },
}).as('design_system')
