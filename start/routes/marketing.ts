...
// Helper to build home page data for the new landing design
function buildHomePageData(i18n: { t: (key: string) => string }) {
  return {
    brand: {
...
// Helper to build pricing page data using pricing2 namespace
function buildPricingPageData(i18n: { t: (key: string) => string }) {
...
// Helper to build about page data using about2 namespace
function buildAboutPageData(i18n: { t: (key: string) => string }) {
...
// Helper to build contact page data using contact2 namespace
function buildContactPageData(i18n: { t: (key: string) => string }) {
