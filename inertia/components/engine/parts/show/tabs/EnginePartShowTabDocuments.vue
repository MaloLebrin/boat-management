...
const documents = computed<MediaRow[]>(() =>
  props.part.documents.filter((m) => m.kind === 'document').sort((a, b) => a.position - b.position)
)
  ...
  <div class="space-y-6">
    ...
    <ul v-else class="space-y-2">
      ...
      >
        ...
        <a
          :href="`/boats/${boat.id}/engines/${engine.id}/parts/${part.id}/media/${doc.id}/download`"
