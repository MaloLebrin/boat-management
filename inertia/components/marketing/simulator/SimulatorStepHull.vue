...
const canProceed = computed(() => Boolean(props.modelValue.hullWear))
</script>
  ...
  <div class="space-y-8">
    <div>
      <label class="mb-3 block text-sm font-medium text-fg">
        {{ t('marketing.simulator.hull_wear_label') }}
      </label>
      <div class="space-y-3">
        <button
        ...
        >
          <span
            :class="[
              ...
              modelValue.hullWear === opt.value ? 'text-coral-700' : 'text-fg',
            ]"
          >
            {{ t(opt.labelKey) }}
          </span>
