...
<template>
  <div class="space-y-5">
    <div>
      <label class="mb-1 block text-base font-semibold text-fg">
        {{ t('simulator.safety_wear_label') }}
      </label>
      <p class="mb-4 text-xs text-fg-muted">{{ t('simulator.safety_mention') }}</p>
      <div class="space-y-2">
        <button
          ...
          :class="[
            ...
            modelValue.safetyWear === opt.value ? opt.colorSelected : opt.colorDefault,
          ]"
        ...
        >
          <div class="flex items-center justify-between">
            ...
            <svg
              v-if="modelValue.safetyWear === opt.value"
