  ...
  >
    <div class="mx-auto max-w-7xl">
      <div class="grid gap-12 lg:grid-cols-2 lg:gap-16">
        <!-- Left: title -->
        <div>
          <p class="mb-2 text-xs font-semibold uppercase tracking-widest text-fg-subtle">{{ subtitle }}</p>
        ...
        <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <div class="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-navy-100 text-xl">
              {{ item.icon }}
            </div>
