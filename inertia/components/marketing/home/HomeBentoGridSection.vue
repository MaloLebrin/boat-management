...
<template>
  ...
  >
    <h2 class="mb-8 text-center font-display text-3xl leading-tight italic text-fg lg:text-4xl">
      {{ bentoGrid.title }}
    </h2>
    ...
    >
      ...
      >
        ...
        <!-- Icon -->
        <div
          class="relative mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-white/10"
        >
          <MapIcon class="h-8 w-8 text-coral-400" />
        </div>
        <p class="relative font-semibold text-white">{{ bentoGrid.items[0].title }}</p>
        <p class="relative mt-1 text-sm text-white/60 leading-relaxed">
      ...
      >
        ...
        <p class="mt-1 text-xs leading-relaxed" :class="cards[idx + 1].descColor">
          {{ item.description }}
        </p>
      </div>
      ...
      >
        ...
        <p class="mt-1 text-xs leading-relaxed" :class="cards[3].descColor">
      ...
      >
        ...
        <p class="mt-1 text-xs leading-relaxed" :class="cards[idx + 4].descColor">
          {{ item.description }}
        </p>
      </div>
    </div>
