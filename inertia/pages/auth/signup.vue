...
<template>
  ...
  <div class="-mx-6 -my-10 sm:-mx-8 flex min-h-[calc(100vh-4rem)] overflow-hidden">
    ...
    <div class="hidden w-[42%] flex-col justify-between bg-navy-800 px-12 py-16 lg:flex">
      ...
      <p class="text-xs text-white/30">{{ t('auth.signup.marketing.copyright', { year: String(new Date().getFullYear()) }) }}</p>
    </div>
      ...
      <div class="mx-auto w-full max-w-sm">
        ...
        <div class="mt-8">
          ...
          <div class="relative my-5">
            ...
            <div class="relative flex justify-center"><span class="bg-cream px-3 text-xs text-fg-subtle">{{ t('auth.signup.withEmail') }}</span></div>
          </div>
          ...
          <Form route="new_account.store" #default="{ processing, errors }">
            <div class="space-y-5">
              ...
              <div class="border-t border-bone pt-4">
                <p class="mb-3 text-xs font-semibold uppercase tracking-wider text-fg-subtle">{{ t('auth.signup.orgSection') }}</p>
                <div class="space-y-3">
                  <BaseInput
                    id="organizationName"
                  ...
                  <div class="flex gap-3">
                    ...
                    <div class="flex-1">
                      <label class="mb-1 block text-sm font-medium text-fg">{{ t('auth.signup.fleetSizeLabel') }}</label>
