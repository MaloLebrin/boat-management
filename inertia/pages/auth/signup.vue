      ...
      <div class="mx-auto w-full max-w-sm">
        ...
        <div class="mt-8">
          ...
          <div class="relative my-5">
            ...
            <div class="relative flex justify-center"><span class="bg-cream px-3 text-xs text-fg-subtle">ou avec email</span></div>
          </div>
          ...
          <Form route="new_account.store" #default="{ processing, errors }">
            <div class="space-y-5">
              ...
              <div class="border-t border-bone pt-4">
                <p class="mb-3 text-xs font-semibold uppercase tracking-wider text-fg-subtle">Ton organisation</p>
                <div class="space-y-3">
                  <BaseInput
                    id="organizationName"
                  ...
                  <div class="flex gap-3">
                    <div class="flex-1">
                      <label class="mb-1 block text-sm font-medium text-fg">Type</label>
                      <select name="organizationType" class="w-full rounded-(--radius-control) border border-bone bg-cream px-3 py-2 text-sm text-fg focus:outline-none focus:ring-2 focus:ring-brand/30">
                        <option value="">Selectionner...</option>
                        <option value="rental">Loueur de bateaux</option>
                        <option value="school">Ecole de voile</option>
                        <option value="marina">Marina / Port</option>
                        <option value="private">Armateur prive</option>
                      </select>
                    </div>
                    <div class="flex-1">
                      <label class="mb-1 block text-sm font-medium text-fg">Taille de flotte</label>
                      <select name="fleetSize" class="w-full rounded-(--radius-control) border border-bone bg-cream px-3 py-2 text-sm text-fg focus:outline-none focus:ring-2 focus:ring-brand/30">
                        <option value="">Selectionner...</option>
                        <option value="1-4">1-4 bateaux</option>
                        <option value="5-20">5-20 bateaux</option>
                        <option value="21-50">21-50 bateaux</option>
                        <option value="51+">51+ bateaux</option>
                      </select>
                    </div>
                  </div>
                </div>
              ...
              <label class="flex cursor-pointer items-start gap-2 text-sm text-fg-muted">
                ...
                <span>J'accepte les <a href="#" class="text-brand hover:underline">CGU</a> et la <a href="#" class="text-brand hover:underline">politique de confidentialite</a></span>
              </label>
